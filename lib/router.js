...
// 南通大学
router.get('/ntu/news/:type', lazyloadRouteHandler('./routes/universities/ntu/index'));
...
// 有知有行
router.get('/youzhiyouxing/materials', lazyloadRouteHandler('./routes/youzhiyouxing/materials'));
// 币世界快讯
